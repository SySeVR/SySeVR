...
def main():
    ...
    f.close()
    dec_path = os.path.join(lang, 'arraysuse_slices_vulline.pkl')
    f = open(dec_path, 'wb')
    pickle.dump(list_all_vulline, f)
    f.close()
    ...
    f.close()
    dec_path = os.path.join(lang, 'pointersuse_slices_vulline.pkl')
    f = open(dec_path, 'wb')
    pickle.dump(list_all_vulline, f)
    f.close()
    ...
    f.close()
    dec_path = os.path.join(lang, 'integeroverflow_slices_vulline.pkl')
    f = open(dec_path, 'wb')
    pickle.dump(list_all_vulline, f)
    f.close()
